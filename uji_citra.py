...
print("Distribusi 'Tekstur Kulit' dalam dataset asli:")
...
model_save_path = "/content/drive/MyDrive/A Skripsi/Model/Uji_Citra_RF.h5"

# Ensure the directory exists
os.makedirs(os.path.dirname(model_save_path), exist_ok=True)

# Save the model using joblib
joblib.dump(model_after, model_save_path)
