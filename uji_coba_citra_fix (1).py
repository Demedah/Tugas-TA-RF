...
def ekstrak_fitur_gambar(img_input):
    try:
        ...
        # Debugging: Check image shape dan type setelah resize
       # print(f"Debug: Image shape setelah resize: {img.shape}, dtype: {img.dtype}")


        # Konversi ke grayscale
        gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
        # Debugging: Check grayscale image shape dan type
       # print(f"Debug: Grayscale image shape: {gray.shape}, dtype: {gray.dtype}")
        ...
        # Debugging: Print GLCM features
       # print(f"Debug: GLCM features: contrast={contrast}, dissimilarity={dissimilarity}, homogeneity={homogeneity}, energy={energy}, correlation={correlation}")
